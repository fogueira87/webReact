  ...
  return (
    <div className='card text-center shadow pt-0' id={`${props.id}`} >
      ...
      <div className='card-body' >
        <h5 className='card-title pb-1 text-secondary'>
          {props.subtitle}
          </h5>
      ...
      >
        ...
        <Modal.Title id={`${props.id}`} className='mx-3' >
        {props.title}
        <Button  id={props.id} variant={props.status} size="sm" onClick={handleShowReserve} className='mx-5 mb-1'>
        {props.go} {props.link}
      </Button> 
        </Modal.Title>
        </Modal.Header>
